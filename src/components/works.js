    ...
    <section id="work">
      ...
      <div className="work">
        <div className="work-thumbnail hover-hidden">
          <img src={travel} className="work-thumbnail-image" alt="travel-log" />
        </div>
          ...
          <Link to="/travel-log">
            <div className="work-item-1">
              ...
              <div className="work-item-description mobile-hidden">
                <h2>travel-log.nl</h2>
                <p>
                  Business plan, design of features (UX&UI), development of MVP.
                </p>
              </div>
              <div className="work-item-tags">
                ...
                <img
                  src={arrow}
                  className="work-item-tags-arrow"
                  alt="arrow down"
                />
              </div>
            </div>
            ...
            <div className="work-item-2">
              <div className="work-item-image desktop-hidden">
                <img
                  src={maatje}
                  className="work-item-image"
                  alt="zorgrobot maatje"
                />
              </div>
              <div className="work-item-description mobile-hidden">
                <h2>Maatje</h2>
                <p>
                  Research, development and evaluation of a technology adoption
                  plan.
                </p>
              </div>
              <div className="work-item-tags">
          ...
          <Link to="/delivar">
            <div className="work-item-3">
              ...
              <div className="work-item-description mobile-hidden">
                <h2>Delivar</h2>
                <p>
                  Research and design of features (UX&UI), development of
                  prototype.
                </p>
              </div>
              <div className="work-item-tags">
          ...
          <Link to="/inflite">
            <div className="work-item-4">
              ...
              <div className="work-item-description mobile-hidden">
                <h2>inflite.nz</h2>
                <p>
                  Created a new UX/UI design and developed it into a website.
                </p>
              </div>
              <div className="work-item-tags">
                <ul>
